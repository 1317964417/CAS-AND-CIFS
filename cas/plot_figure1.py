...
file_name = './Magnitude/cifar10_std_layer4_class0_1e-2_1.npy'
...
save_name = 'value_cifar10_resnet18_std_train_layer4_1e-2_1'
...
ax1.set_ylabel('Magnitude of activation', fontdict={'family': 'Times Roman', 'size': 12})
