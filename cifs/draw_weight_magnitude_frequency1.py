...
for index in range(10):
    ...
    plt.figure()
    path0 = './layersaved/std_training_natural_and_pgd_attack/'+classes[index]+'/l4(magnitude)_stdtrain_for_natural.csv'.format(index)
    path1 = './layersaved/std_training_natural_and_pgd_attack/'+classes[index]+'/l4(magnitude)_stdtrain_for_pgd.csv'.format(index)
    path2 = './layersaved/std_training_natural_and_pgd_attack/'+classes[index]+'/l4(Frequency)_stdtrain_for_natural.csv'.format(index)
    path3 = './layersaved/std_training_natural_and_pgd_attack/'+classes[index]+'/l4(Frequency)_stdtrain_for_pgd.csv'.format(index)
    path4 = './layersaved/std_training_natural_and_pgd_attack/'+classes[index]+'/linear(weight)_stdtrain.csv'.format(index)

    path5 = './layersaved/pgd_training_natural_and_pgd_attack/'+classes[index]+'/l4(magnitude)_pgdtrain_for_natural.csv'.format(index)
    path6 = './layersaved/pgd_training_natural_and_pgd_attack/'+classes[index]+'/l4(magnitude)_pgdtrain_for_pgd.csv'.format(index)
    path7 = './layersaved/pgd_training_natural_and_pgd_attack/'+classes[index]+'/l4(Frequency)_pgdtrain_for_natural.csv'.format(index)
    path8 = './layersaved/pgd_training_natural_and_pgd_attack/'+classes[index]+'/l4(Frequency)_pgdtrain_for_pgd.csv'.format(index)
    path9 = './layersaved/pgd_training_natural_and_pgd_attack/'+classes[index]+'/linear(weight)_pgdtrain.csv'.format(index)
    ...
    m0=data0_sort[::-1]
    m1=data1_sort[::-1]
    plt.plot(m0,color='green',alpha=0.6,label='{}_std_training_natural examples'.format(classes[index]))
    plt.plot(m1,color='blue',alpha=0.4,label='{}_std_training_pgd examples'.format(classes[index]))
    ...
    W0=data4_sort[::-1]
    plt.plot(W0,color='green',alpha=0.6,label='{}_weigth'.format(classes[index]))
    plt.grid(linestyle='--')
    ...
    F0=data2_sort[::-1]
    F1=data3_sort[::-1]
    plt.plot(F0,color='green',alpha=0.6,label='{}_std_training_natural examples'.format(classes[index]))
    plt.plot(F1,color='blue',alpha=0.4,label='{}_std_training_pgd examples'.format(classes[index]))
    plt.grid(linestyle='--')
    ...
    m00=data5_sort[::-1]
    m11=data6_sort[::-1]
    plt.plot(m00,color='green',alpha=0.6,label='{}_pgd_training_natural examples'.format(classes[index]))
    plt.plot(m11,color='blue',alpha=0.4,label='{}_pgd_training_pgd examples'.format(classes[index]))
    ...
    W00=data9_sort[::-1]
    plt.plot(W00,color='green',alpha=0.6,label='{}_weigth'.format(classes[index]))
    plt.grid(linestyle='--')
    ...
    F00=data7_sort[::-1]
    F11=data8_sort[::-1]
    plt.plot(F00,color='green',alpha=0.6,label='{}_pgd_training_natural examples'.format(classes[index]))
    plt.plot(F11,color='blue',alpha=0.4,label='{}_pgd_training_pgd examples'.format(classes[index]))
    plt.grid(linestyle='--')
